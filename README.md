<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Unstructured" width="144" />
  </picture>
</p>
...
Document parsing via the Apache-2.0 Unstructured library: the broadest-coverage `document.parse` backend, reading roughly sixty formats including the whole Office family.
...
**App:** [Install](ryu://apps/@ryu/unstructured) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/unstructured
```
...
<a href="https://github.com/amajorai/ryu-unstructured/stargazers">
  <picture>
